...
with(householdPowerConsumption, plot(dateTime, Global_active_power,type = "n",
                                     ylab="Global Active Power (kilowatts)",
                                     xlab=""))
with(householdPowerConsumption,lines(dateTime,Global_active_power))

#Plot(1,2)
with(householdPowerConsumption, plot(dateTime,Voltage,type = "n",
                                     ylab="Voltage",
                                     xlab="datetime"))
...
#Plot (2,2)
with(householdPowerConsumption, plot(dateTime,Global_reactive_power,type = "n",
